...
HackerRank Question URL: https://www.hackerrank.com/challenges/java-method-overriding/problem?isFullScreen=true
...
class Soccer extends Sports {
    ...
    // Overiding getName and getNumberOfTeamMembers methods
    void getNumberOfTeamMembers() {
